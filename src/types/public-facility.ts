...
export const FACILITY_CATEGORY_COLORS: Record<FacilityCategory, {
  ...
  '図書館':    { bg: 'rgba(59,130,246,0.18)',   text: '#1D4ED8',  marker: '#3b82f6',  spriteIcon: 'library' },
  '体育館':    { bg: 'rgba(34,197,94,0.18)',    text: '#166534',  marker: '#22c55e',  spriteIcon: 'sports' },
  '公民館':    { bg: 'rgba(168,85,247,0.18)',   text: '#7E22CE',  marker: '#a855f7',  spriteIcon: 'public-facility-navy' },
  '区民事務所': { bg: 'rgba(239,68,68,0.18)',    text: '#B91C1C',  marker: '#ef4444',  spriteIcon: 'public-facility-red' },
  '児童館':    { bg: 'rgba(249,115,22,0.18)',   text: '#C2410C',  marker: '#f97316',  spriteIcon: 'daycare' },
  '集会所':    { bg: 'rgba(20,184,166,0.18)',   text: '#0F766E',  marker: '#14b8a6',  spriteIcon: 'public-facility-navy' },
  '福祉施設':  { bg: 'rgba(236,72,153,0.18)',   text: '#BE185D',  marker: '#ec4899',  spriteIcon: 'welfare-facility' },
  '子育て施設': { bg: 'rgba(245,158,11,0.18)',   text: '#B45309',  marker: '#f59e0b',  spriteIcon: 'baby' },
  'ホール':    { bg: 'rgba(99,102,241,0.18)',   text: '#4338CA',  marker: '#6366f1',  spriteIcon: 'museums' },
  '学校':      { bg: 'rgba(6,182,212,0.18)',    text: '#0E7490',  marker: '#06b6d4',  spriteIcon: 'preschool' },
  '公園':      { bg: 'rgba(132,204,22,0.18)',   text: '#4D7C0F',  marker: '#84cc16',  spriteIcon: 'park' },
  'その他':    { bg: 'rgba(107,114,128,0.18)',  text: '#374151',  marker: '#6b7280',  spriteIcon: 'public-facility-navy' },
};
